...
export default class SongInCategoryScreen extends React.Component {
  ...
  componentWillMount = async () => {
    try {
      const url =
        ...
        Global.CATEGORY_URL.GET_LIST_WITH_SLUG+
        this.props.navigation.state.params.slug;
      const response = await fetch (url);
      const data = await response.json ();
      const posts = data.ListSong;
  ...
  //     const url =
  //       Global.BASE_URL +
  //       Global.CATEGORY_URL.GET_SEARCH_WITH_SLUG +
  //       text +
  //       Global.CATEGORY_URL.SLUG +
  //       this.props.navigation.state.params.slug;
  //     const response = await fetch (url);
  ...
  //   }
  // };
  renderPost = ({Name, Slug, VersionSlug}, i) => {
